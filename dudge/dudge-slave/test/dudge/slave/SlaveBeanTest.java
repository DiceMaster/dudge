...
public class SlaveBeanTest extends TestCase {
	...
	/** 
	 * Проверка выполнения решения на наборе тестов. 
	 * Решение на первом тесте должно быть верным, а на втором - нет.
	 */
	...
	/**
	 * Проверяет статус выполнения теста при попытке выполнения 
	 * некомпилируемой задачи.
	 */
