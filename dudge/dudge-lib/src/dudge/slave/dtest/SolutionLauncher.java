...
/**
 * Класс, содержащий методы для создания и удаления временных папок, запуска решения и установки ему ограничений. Большинство методов этого класса реализовано в
 * платформозависимой тестирующей библиотеке dtest.
 *
...
public class SolutionLauncher {
	...
	static {
		try {
			...
			logger.log(Level.SEVERE, "Failed to load library dtest/libdtest. java.library.path" + System.getProperty("java.library.path"), e);
			throw e;
		}
