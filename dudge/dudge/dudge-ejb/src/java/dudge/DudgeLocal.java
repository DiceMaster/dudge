...
public interface DudgeLocal {
	 ...
	 * При успешной аутентификации ее состояние будет запомнено
	 * на всю последующую сессию.
	 ...
	 * @return true при наличии данного права у пользователя в этом соревновании,
	 * иначе false.
	 */
	 ...
	 * @param login имя пользователя.
	 * @contestId идентификатор соревнования.
	 * @return true при наличии у пользователя какой-либо роли в этом соревновании,
	 * иначе false.
	 */
	...
	/**
	 * Присоединяется пользователем ко всем открытым соревнованиям,
	 * т.е. тем, в которых можно участвовать без отдельной подачи заявки.
	 * @param login имя пользователя
	 */
	...
	/**
	 * Возвращает список решений задачи, отправленных определенным пользователем
	 * в конкретное соревнование. При формировании списка учитывается время отправки
	 * решений, время начала соревнования, а также его длительность - так, что
	 * решения, отправленные после окончания или до начала соревнования, не попадут
	 * в результат.
	 ...
	 * @return отсортированный по возрастанию давности список
	 * из последних count поступивших решений.
	 */
	...
	/**
	 * Перепроверяет группу решений в соревновании для данной
	 * задачи.
	 * @param contestId идентификатор соревнования;
	 * @param problemId идентификатор задачи.
	 */
	 ...
	 * @return путь, который хранится в параметре bug_tracking_path таблицы
	 * params базы данных или путь по умолчанию, если такого параметра нет.
	 */
