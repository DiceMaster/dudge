...
/**
 * Класс характерных свойств соревнования, определяющих взаимодействие с ним остальных частей системы.
 *
...
public interface ContestTraits extends Serializable {
	 ...
	 *
	 * @return true если все тесты должны быть запущены, false - если до первого неудачного.
	 */
