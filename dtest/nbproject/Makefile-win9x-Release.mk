...
${OBJECTDIR}/src/jni/methods_impl.o: src/jni/methods_impl.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/jni/methods_impl.o src/jni/methods_impl.cpp

${OBJECTDIR}/src/unix/unix_ops.o: src/unix/unix_ops.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/unix
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/unix/unix_ops.o src/unix/unix_ops.cpp

${OBJECTDIR}/src/win/dtest_win.o: src/win/dtest_win.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/win
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/win/dtest_win.o src/win/dtest_win.cpp

${OBJECTDIR}/src/win/threads.o: src/win/threads.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/win
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/win/threads.o src/win/threads.cpp

${OBJECTDIR}/src/win/stdafx.o: src/win/stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/win
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/win/stdafx.o src/win/stdafx.cpp

${OBJECTDIR}/src/unix/dtest_unix.o: src/unix/dtest_unix.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/unix
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/unix/dtest_unix.o src/unix/dtest_unix.cpp

${OBJECTDIR}/src/win/winapi_ops.o: src/win/winapi_ops.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/win
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/win/winapi_ops.o src/win/winapi_ops.cpp

${OBJECTDIR}/src/jni/utilf.o: src/jni/utilf.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/jni
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINDOWS=0x0410 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/jni/utilf.o src/jni/utilf.cpp
